...
public class BinarySearchTreeMethodsTest {
    ...
    public void sampleTest1() {
         ...
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("m", "g", "s", "c", "d", "i",
                "h", "v", "u", "z");
        BinaryTree<String> t2 = createBSTFromArgs("m", "g", "s", "c", "d", "i",
                "h", "v", "u", "z");
        /*
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "m");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(true, inTree);
